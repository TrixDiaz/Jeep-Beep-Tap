        ...
        <div class="flex flex-col-reverse md:flex-row">
            ...
            <form class="w-full self-center" method="POST" action="{{ route('login') }}">
                ...
                <div x-data="{ showPassword: false }" class="mb-4">
                    ...
                    <div class="relative">
                        <x-input id="password" class="block mt-1 w-full pr-10" type="password" name="password" x-bind:type="showPassword ? 'text' : 'password'" required autocomplete="current-password" />

                        <div class="absolute inset-y-0 right-0 pr-3 flex items-center text-gray-500 cursor-pointer" @click="showPassword = !showPassword">
                ...
                <div class="flex flex-col items-center md:flex-row md:items-center justify-between mt-4">
                  ...
                  <div class="flex flex-col items-center md:flex-row md:items-center justify-center md:justify-between mt-4">
                      <a wire:navigate
                         class="mr-4 underline text-sm text-gray-600 hover:text-gray-900 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                         href="{{ route('register') }}">
