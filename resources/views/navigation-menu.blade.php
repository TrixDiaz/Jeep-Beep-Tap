                        ...
                        <span class="inline-flex rounded-md">
                            <button type="button"
                                ...
                                <div class="relative flex">
                                    <div id="notification-count" class="relative inline-flex  border-2 border-white rounded-full -top-3 right-2 dark:border-gray-900">
